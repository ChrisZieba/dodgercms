    ...
    function menu(bucket, endpoint, callback) {
        async.waterfall([
            ...
            function(keys, waterfallCb) {
                ...
                function buildFromSegments(scope, key, pathSegments, keyLabel) {
                    ...
                    if (!found) {
                        if (!pathSegments.length && keyLabel) {
                            label = keyLabel;
                        }
                    ...
                    if (pathSegments.length) {
                        ...
                        buildFromSegments(found.children, key, pathSegments, keyLabel);
                    }
                }
                ...
                keys.forEach(function(object) {
                    ...
                    buildFromSegments(tree, [], parts, label);
                });
